...
def registro_facial():
    ...
    ventana2 = cv2.VideoCapture(1)                #Elegimos la camara con la que vamos a hacer la deteccion
    global n 
    global direc
    n = 0
    num = 0
    ...
    while(True):
        ...
        cv2.putText(frame,"Manten tu dentro del ovalo", 
            (100,a-30),cv2.FONT_HERSHEY_TRIPLEX,
            1,(255,0,0),1)
        ...
        if num >= 40:                                #se para la captura de imagenes al completar los ciclos
